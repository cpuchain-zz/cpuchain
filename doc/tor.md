...
versions of Tor see [Section 3](#3-automatically-listen-on-tor).*
	...
	HiddenServicePort 19706 127.0.0.1:19706
	HiddenServicePort 29706 127.0.0.1:29706

The directory can be different of course, but (both) port numbers should be equal to
your bitcoind's P2P listen port (19706 by default).
...
and open port 19706 on your firewall (or use -upnp).
