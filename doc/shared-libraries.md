...
The purpose of this library is to make the verification functionality that is critical to CPUchain's consensus available to other applications, e.g. to language bindings.
